...
for i in range(1,100):
  ip=[]  
  url="https://www.amazon.in/Apple-iPhone-11-Pro-256GB/product-reviews/B00MITLPX2/ref=cm_cr_arp_d_paging_btm_next_2?showViewpoints=1&pageNumber="+str(i)
...
with open("iphine.txt","w",encoding='utf8') as output:
...
with open("C:\\Data Science\\Assignments\\Module-Textmining\\Codes\\stopwords.txt","r") as sw:
        stop_words = sw.read()
...
with open("C:\\Data Science\\Assignments\\Module-Textmining\\Codes\\positive-words.txt","r") as pos:
...
with open("C:\\Data Science\\Assignments\\Module-Textmining\\Codes\\negative-words.txt", "r") as neg:
